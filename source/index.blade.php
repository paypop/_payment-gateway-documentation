...
@section('body')
<section class="container max-w-6xl mx-auto px-6 py-8 md:py-10">
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-14">
        <div class="mt-8">
            <h1 id="intro-docs-template">MetaPay</h1>

            <h2 id="intro-powered-by-jigsaw" class="font-light mt-4">Payment Gateway for Monero</h2>

            <p class="text-lg">Accept Monero on your business online.</p>

            <div class="flex my-10">
                <a href="/docs/installation" title="{{ $page->siteName }} getting started" class="bg-orange-600 hover:bg-orange-500 font-normal text-white hover:text-white rounded mr-4 py-2 px-6">Get Started</a>
        ...
        <img src="/assets/img/logo2.svg" alt="{{ $page->siteName }} large logo" class="mx-auto mb-6 lg:mb-0 ">
    </div>
</section>

<section>
    <div class="container custom-icons">
        <style>
            .custom-icons svg {
                transform: scale(2);
            }
        ...
        @php
            $contents = [
                [
                    ...
                    'p' => 'Keep the control on your wallet, your server, your database.'
                ],
                [
        ...
        <div class="flex justify-center mx-auto">
            @foreach($contents as $content)
                <div class="mb-8 mx-3 px-2 md:w-1/3">
                    ...
                    <h3 class="text-2xl text-gray-900 mb-0">{{ $content['title'] }}</h3>
...
<div class="p-8 text-center">
    <div class="container">
        <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Support on Patreon</button>
    </div>
</div>
@endsection
